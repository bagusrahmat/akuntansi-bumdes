<%@ Page Title="" Language="C#" MasterPageFile="~/hlm/Site1.Master" AutoEventWireup="true" CodeBehind="laba_rugi.aspx.cs" Inherits="bumdesAPP.hlm.laba_rugi" %>
    ...
    <div class="body">
        ...
        <table>
            <tr>
                ...
                <td style="padding-left:10px"><asp:Button ID="lihatLabaRugi" runat="server" Text="Lihat" style="background-color:#1DA1F2; border-radius: 16px" ForeColor="white" BorderStyle="none" Height="34px" Width="100px" OnClick="lihatLabaRugi_Click" /></td>
            </tr>
        </table>
