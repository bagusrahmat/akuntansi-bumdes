...
{
    public partial class neraca_saldo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lblperiode.Text = "NERACA SALDO S/D " + DateTime.Today.ToString("dd MMM yyyy") + "";
            }
            lihatData();
        }
        ...
        {
            lihatData();
            if (TextBoxPeriode1.Text == "") lblperiode.Text = "NERACA SALDO S/D " + DateTime.Today.ToString("dd MMM yyyy") + "";
            else lblperiode.Text = "NERACA SALDO PERIODE " + Convert.ToDateTime(TextBoxPeriode1.Text).ToString("dd MMM yyyy") + " S/D " + Convert.ToDateTime(TextBoxPeriode2.Text).ToString("dd MMM yyyy") + "";
        }
